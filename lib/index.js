(function() {
  var EncodedSubdomain, IPAddressSubdomain, PATTERN, Server, Subdomain, db, decode, dirty, dnsserver, encode, express, get_address, log, validate_address, xip,
  ...
  exports.createWebServer = function(config) {
    ...
    return app.get('/update', function(req, res) {
      var address, from_address, name, row, _ref, _ref2, _ref3, _ref4;
      res.contentType('json');
      name = ((_ref = (_ref2 = req.param('subdomain')) != null ? _ref2 : req.param('d')) != null ? _ref : '').trim();
      address = get_address((_ref3 = req.param('address')) != null ? _ref3 : req.param('a'));
      from_address = (_ref4 = req.header('X-FORWARDED-FOR')) != null ? _ref4 : req.connection.address().address;
      if (!name || name === '') {
        return res.send({
          err: 'empty subdomain'
        });
