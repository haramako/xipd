(function() {
  var EncodedSubdomain, IPAddressSubdomain, PATTERN, Server, Subdomain, db, decode, dirty, dnsserver, encode, express, get_address, log, path, punycode, validate_address, xip,
  ...
  exports.createWebServer = function(config) {
    var app, k, msg, name, special, specialSrc, _i, _len, _ref;
    app = express();
  ...
  exports.Server = Server = (function(_super) {
    ...
    function Server(config) {
      ...
      this.dns_expire = this.config.dns_expire || 3600;
    ...
    Server.prototype.createSOA = function() {
      ...
      refresh = this.dns_expire * 8;
      retry = this.dns_expire * 2;
      expire = this.dns_expire;
      minimum = this.dns_expire / 2;
