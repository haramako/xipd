(function() {
  var EncodedSubdomain, IPAddressSubdomain, PATTERN, Server, Subdomain, decode, dirty, dnsserver, encode, express, fixAddr,
  ...
  exports.Subdomain = Subdomain = (function() {
    ...
    function Subdomain(subdomain, db) {
      ...
      if (fixAddr[this.subdomain]) {
        this.address = fixAddr[this.subdomain];
      } else {
